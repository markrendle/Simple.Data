...
namespace Simple.Data
{
    ...
    {
        private static IReadOnlyDictionary<string, object> NamedArgumentsToDictionary(IEnumerable<string> argumentNames, IEnumerable<object> args)
        {
        ...
        private static IReadOnlyDictionary<string, object> ArgumentsToDictionary(IEnumerable<String> argumentNames, IEnumerable<object> args)
        {
            ...
            if (argsArray.Length == 1 && argsArray[0] is IDictionary<string, object>)
                return (IReadOnlyDictionary<string, object>)argsArray[0];
        ...
        internal static IReadOnlyDictionary<string, object> NamedArgumentsToDictionary(this InvokeMemberBinder binder, IEnumerable<object> args)
        {
