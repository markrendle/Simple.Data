...
namespace Simple.Data.SqlServer.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to select rc.CONSTRAINT_NAME, fkcu.TABLE_SCHEMA,&apos;{0}&apos; As TABLE_NAME, fkcu.COLUMN_NAME,
        ///pkcu.TABLE_SCHEMA AS UNIQUE_TABLE_SCHEMA, pkcu.TABLE_NAME AS UNIQUE_TABLE_NAME, pkcu.COLUMN_NAME AS UNIQUE_COLUMN_NAME,
        ///fkcu.ORDINAL_POSITION
        ///FROM  {1}INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS rc
        ///JOIN  {1}INFORMATION_SCHEMA.KEY_COLUMN_USAGE fkcu ON rc.CONSTRAINT_NAME = fkcu.CONSTRAINT_NAME
        ///JOIN  {1}INFORMATION_SCHEMA.KEY_COLUMN_USAGE pkcu ON rc.UNIQUE_CONSTRAINT_NAME = pkcu.CONSTRAINT_NAME
        ///WHERE fkcu.ORDINAL_POSITION  [rest of string was truncated]&quot;;.
        /// </summary>
        internal static string RemoteForeignKeysSql {
            get {
                return ResourceManager.GetString("RemoteForeignKeysSql", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to select kcu.TABLE_SCHEMA, &apos;{0}&apos; As TABLE_NAME, kcu.CONSTRAINT_NAME, tc.CONSTRAINT_TYPE, kcu.COLUMN_NAME, kcu.ORDINAL_POSITION
        ///  from {1}INFORMATION_SCHEMA.TABLE_CONSTRAINTS as tc
        ///  join {1}INFORMATION_SCHEMA.KEY_COLUMN_USAGE as kcu
        ///    on kcu.CONSTRAINT_SCHEMA = tc.CONSTRAINT_SCHEMA
        ///   and kcu.CONSTRAINT_NAME = tc.CONSTRAINT_NAME
        ///   and kcu.TABLE_SCHEMA = tc.TABLE_SCHEMA
        ///   and kcu.TABLE_NAME = tc.TABLE_NAME
        /// where tc.CONSTRAINT_TYPE = &apos;PRIMARY KEY&apos;
        /// AND upper(kcu.table_name) = upper(&apos;{2}&apos;).
        /// </summary>
        internal static string RemotePrimaryKeySql {
            get {
                return ResourceManager.GetString("RemotePrimaryKeySql", resourceCulture);
            }
        }
    }
}
